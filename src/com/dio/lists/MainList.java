...
public class MainList {
	...
	public static void main(String[] args) {
		...
		/*
		 * Testando os m�todo da classe ArrayList
		 * 
		...
		// atualizando um elemento da lista pelo �ndice
		notas.set(6, 1d);
		
		System.out.println("ARRAY 01");
		System.out.println(notas);
		System.out.println("***************************************************");
		System.out.println("ARRAY 01 com La�o For Each");
		for (Double n : notas) {
			System.out.print(n + " ");
		}
		System.out.println();
		...
		System.out.println("***************************************************");
		System.out.println("No Array 01 cont�m a nota 10? -> " + notas.contains(10.0));
		System.out.println("No Array 01 exiba a 3� nota adicionada -> " + notas.get(2));
		...
		System.out.println("M�dia dos elementos do Array 01 -> " + (soma / notas.size()));
		System.out.printf("M�dia dos elementos do Array 01 -> %.2f\n", (soma / notas.size()));
		notas.remove(0);
		notas.remove(6.5);
		System.out.println("ARRAY 01 Ap�s exclus�o do primeiro elemento e do elemento 6.5");
		System.out.println(notas);
		
		System.out.println("***************************************************");
		*/
		
		Gato siames = new Gato(LocalDate.parse("2022-01-01"), "Sião", 9, "Prateado");
		...
		Gato himalaio = new Gato(LocalDate.parse("2018-07-01"),"Aiatolá", 8, "Preto");
		Gato azulRusso = new Gato(LocalDate.parse("2018-07-03"),"Lenin", 11, "Cinza");
		Gato scottishFold = new Gato(LocalDate.parse("2021-10-09"),"Uísque", 12, "Tigrado");
		
		List<Gato> gatos = new ArrayList<>
		(Arrays.asList(
				siames, persa, sphynx, munchkin, siberiano, sphynx2, himalaio, azulRusso, scottishFold));
//		System.out.println("*********************************************************");
//		System.out.println("******************POR ORDEM DE INSER��O******************");
//		System.out.println("*********************************************************");
//		imprimir(gatos);
//		System.out.println("*********************************************************");
//		System.out.println("****************ORDEM ALEAT�RIA - SHUFFLE****************");
//		System.out.println("*********************************************************");
